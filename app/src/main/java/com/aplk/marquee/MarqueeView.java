...
//        }
    ...
    private TextView createTextView(final CharSequence text) {
        ...
        textView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (onItemClickListener != null) {
                    onItemClickListener.onItemClick(text, (TextView) v);
                }
            }
        });
    ...
    public interface OnItemClickListener {
        void onItemClick(CharSequence text, TextView textView);
    }
